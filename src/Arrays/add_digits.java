...
<description><p>Given an integer num, repeatedly add all its digits until the result has only one digit, and return it.</p><p>Example 1:</p><p>Input: num = 38</p><p>Output: 2</p><p>Explanation: The process is 38 --&gt; 3 + 8 --&gt; 11 11 --&gt; 1 + 1 --&gt; 2 Since 2 has only one digit, return it.</p><p>Example 2:</p><p>Input: num = 0</p><p>Output: 0</p><p>Follow up: Could you do it without any loop/recursion in O(1) runtime?</p></description>
