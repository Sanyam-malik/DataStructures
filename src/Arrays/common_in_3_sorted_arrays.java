/*
<metadata>
<name>Common in 3 Sorted Arrays</name>
<description>Given three sorted arrays in non-decreasing order, return all common elements in non-decreasing order across these arrays. If there are no such elements return an empty array.
...
Output: [1, 2]
Explanation: Ignoring duplicates, 1 and 2 are present in all three arrays, so the output is [1, 2].</description>
<url>https://www.geeksforgeeks.org/problems/common-elements1132/1</url>
<status>Completed</status>
<date>2026-05-20</date>
<level>Easy</level>
<companies>VMWare:Microsoft</companies>
</metadata>
*/
class Solution {
