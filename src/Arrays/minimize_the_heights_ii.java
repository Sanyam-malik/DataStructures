...
Output: 11
Explanation: The array can be modified as [3+k, 9+k, 12-k, 16-k, 20-k] = [6, 12, 9, 13, 17]. The difference between the largest and the smallest is 17-6 = 11. </description>
...
<companies>Adobe:Microsoft</companies>
</metadata>
*/
class Solution {
